...
import '../artificer/planner_lock_styles.css'
import { useEffect } from "react";


const PlanLock = (props) => {

    useEffect(() => {
        document.getElementById("inpLock").defaultChecked  = props.isLocked;
        console.log(`Plan Locked ->>> ${document.getElementById("inpLock").checked}`)
    }, [props.isLocked, props.onClickFunc]);

    return(
    <>
   
        <input id="inpLock" type="checkbox" disabled={false} onClick={props.onClickFunc} checked={props.clientLock}/>
