...
const DateInput = (props) => {
    ...
    <>
    <MDBCol size={4}>
    <MDBInput label='Example label' id='formTextExample1' type='date' aria-describedby='textExample1' placeholder="0-100" defaultValue='' readonly={true}/>
                <div id='textExample1' className='form-text core-input-label'>
                    <p className='core-input-label-text'>Date Input Element  
