    ...
    return(
        ...
        {props.newRow ?
         ...
         <div id={`${props.alias}Label`} className='form-text form-hint'>{props.placeholder}</div>
                    ...
                    readOnly={props.readOnly} disabled={props.disabled} checked={props.value.includes(`${props.alias}`)} value={props.alias} onBlur={props.onBlur} onChange={props.onChange}/><span className="slider round"></span></label>
         </>
